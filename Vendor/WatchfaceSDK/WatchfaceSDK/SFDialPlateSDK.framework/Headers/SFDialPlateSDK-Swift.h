...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (NSInteger)getCompleteBytes SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)getTotalBytes SWIFT_WARN_UNUSED_RESULT;
/// 推送表盘文件
/// \param devIdentifier 目标设备的identifier字符串。通过CBPeripheral.identifier.uuidString获取
///
/// \param type 文件类型。0-表盘，1-多语言，2-背景图，3-自定义，4-音乐,5-JS,8-4g模块,9-sfwatchface。其它类型查阅文档。
///
