...
///
- (void)initializeWithRegion:(enum Region)region watchInfos:(NSArray<WatchInfo *> * _Nonnull)watchInfos onSuccess:(void (^ _Nonnull)(NSArray<WatchInfo *> * _Nonnull))onSuccess onFailure:(void (^ _Nonnull)(ErrorCode * _Nonnull))onFailure;
/// 将语音数据转换成文本
...
///
/// \param onSuccess 成功回调闭包，参数说明：
/// - <code>productsSubscription</code>: 所有订阅产品信息。
///
/// \param onFailure 失败回调，参数说明：
/// - <code>ErrorCode</code>：包含错误码以及错误描述。
/// - <code>code</code>: 错误码。
/// - <code>message</code>: 错误信息。
///
- (void)queryProductsSubscriptionWithWid:(NSString * _Nonnull)wid onSuccess:(void (^ _Nonnull)(NSArray<ProductsSubscription *> * _Nonnull))onSuccess onFailure:(void (^ _Nonnull)(ErrorCode * _Nonnull))onFailure;
/// 获取设备所有订单
/// \param wid 数据的唯一标识符。
///
/// \param pageNum 订单页码。
...
///
/// \param onSuccess 成功回调闭包。
///
/// \param onFailure 失败回调。
///
- (void)queryAllOrderWithWid:(NSString * _Nonnull)wid pageNum:(NSInteger)pageNum pageSize:(NSInteger)pageSize onSuccess:(void (^ _Nonnull)(NSArray<Order *> * _Nonnull))onSuccess onFailure:(void (^ _Nonnull)(ErrorCode * _Nonnull))onFailure;
@end
...
SWIFT_CLASS("_TtC9NativeLib5Order")
@interface Order : NSObject
@property (nonatomic, copy) NSString * _Nonnull orderId;
@property (nonatomic, copy) NSString * _Nonnull orderPrice;
@property (nonatomic, copy) NSString * _Nonnull orderCurrency;
...
- (nonnull instancetype)initWithOrderId:(NSString * _Nonnull)orderId orderPrice:(NSString * _Nonnull)orderPrice orderCurrency:(NSString * _Nonnull)orderCurrency orderStatus:(NSInteger)orderStatus orderNum:(NSInteger)orderNum orderType:(NSInteger)orderType startTime:(int64_t)startTime endTime:(int64_t)endTime OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9NativeLib20ProductsSubscription")
@interface ProductsSubscription : NSObject
@property (nonatomic) NSInteger productSource;
@property (nonatomic) NSInteger productType;
@property (nonatomic) NSInteger productGrade;
@property (nonatomic) NSInteger remainingNum;
@property (nonatomic) NSInteger expireAt;
- (nonnull instancetype)initWithProductSource:(NSInteger)productSource OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, Region, "Region", open) {
  RegionNONE = 0,
  RegionOVERSEAS = 1,
  RegionCHINA = 2,
};
